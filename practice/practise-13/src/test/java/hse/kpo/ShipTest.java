...
public class ShipTest {
    ...
    void shipTest() {
        ...
        var ship1 = flyingShipFactory.create(EmptyEngineParams.DEFAULT);
        var ship2 = handShipFactory.create(EmptyEngineParams.DEFAULT);
        var ship3 = pedalShipFactory.create(new PedalEngineParams(6));
